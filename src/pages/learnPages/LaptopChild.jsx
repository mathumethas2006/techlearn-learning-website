    ...
    <>
      ...
      <div className="learning">
        <div className="content-page">
          ...
          <p>
            The AC operates on 230V AC supply. The internal SMPS converts AC to
            regulated DC voltage required for microcontroller, sensors and
            display panel.
          </p>

          <h3>2. Refrigeration Cycle</h3>
          <p>
            The refrigeration cycle consists of four main stages: Compression,
            Condensation, Expansion, and Evaporation. The refrigerant absorbs
            heat from indoor air and releases it outside.
          </p>

          <h3>3. Compressor Unit</h3>
          <p>
            The compressor increases refrigerant pressure and temperature.
            Modern inverter ACs use variable speed compressors to improve energy
            efficiency.
          </p>

          <h3>4. Heat Exchange System</h3>
          <p>
            The evaporator coil absorbs room heat. The condenser coil releases
            absorbed heat outdoors. Copper tubing improves thermal conductivity.
          </p>
